...
function App() {
  ...
  return (
    <div className="container d-flex justify-content-center align-items-center vh-100">
      {!showSignUp ? (
        <div className="card p-4 shadow" id="loginCard" style={{ minWidth: 350, background: '#fff', color: '#000', border: '1px solid #000' }}>
          ...
          <div className="text-center mt-3">
            ...
            <button className="btn btn-link text-primary p-0" id="signupLink">Sign up</button>
          </div>
        </div>
      ) : (
        <div className="card p-4 shadow" id="signupCard" style={{ minWidth: 350, background: '#fff', color: '#000', border: '1px solid #000' }}>
          ...
          <div className="text-center mt-3">
            ...
            <button className="btn btn-link text-primary p-0" id="backToLogin">Log in</button>
          </div>
        </div>
      )}
    </div>
